...
export default function Header() {
  ...
  const handleConnectButton = useCallback(() => {
    ...
    if (!connector.ready) {
      window.alert(
        "You didn't install MetaMask. You have to install MetaMask."
      );
    } else {
      if (isConnected) {
        disconnect();
  ...
  useEffect(() => {
    setHasMetaMask(connector.ready);
  }, [hasMetaMask]);
            ...
            <div className="px-4 mx-auto lg:px-9 xl:px-10 mosh-container-xl">
              <div className="flex items-center justify-between">
                ...
                <div className="items-center hidden md:flex">
                  ...
                  <Button
                    className="px-5 py-2 ml-2.5 font-bold rounded-md md:w-auto text-secondary h-11 bg-sweetTurquoise"
